<%@ Page Language="C#" AutoEventWireup="true" Debug="true" CodeFile="book2.aspx.cs" Inherits="book2" %>
   ...
   <a href="proje.aspx">Login</a> 
    ...
    <div class="bookPage">
        <div id="bookPage-left">
            <div id="book-image">
                <div>
                    <img id="responsiveImg" src="book2.jpg" alt="Book 2">
        ...
        <div id="bookPage-right">
            <div id="book-details">
                <h2>Hunger Games</h2>
                <p id="summary"><span style="color: #450202;"><strong>Summary:</strong></span>Sixteen-year-old Katniss Everdeen regards it as a death sentence when she is forced to represent her district in the annual Hunger Games, a fight to the death on live TV. But Katniss has been close to death before - and survival, for her, is second nature. The Hunger Games is a searing novel set in a future with unsettling parallels to our present.</p>
                <hr>
                <p id="writer"><span style="color: #450202;"><strong>Writer:</strong></span> Suzanne Collins</p>
                <hr>
                <a id="purchase-button" href="https://www.amazon.com.tr/Hunger-Games-Scholastic-S-COLLINS/dp/0439023521" target="_blank">Purchase</a>
            </div>
        </div>
